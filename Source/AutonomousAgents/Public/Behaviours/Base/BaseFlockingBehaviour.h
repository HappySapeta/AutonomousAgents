...
protected:
	...
	bool CanOtherAgentAffect(const UAgent* AffectedAgent, const UAgent* OtherAgent) const
	{
		return Utility::IsPointInFOV(
			AffectedAgent->Location, AffectedAgent->GetForwardVector(), OtherAgent->Location,
